...
import com.example.mobileproject.ui.tools.ToolsFragment;
...
public class TimeThread extends Thread {
    ...
    private ShareFragment hf = null;
    private int start = 30;

    public TimeThread(Handler handler, int time, TextView txtTime, ShareFragment hf) {
